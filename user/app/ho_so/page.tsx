...
//   // 📷 Khi chọn file → set file + preview
//   function handleFileChange(e: ChangeEvent<HTMLInputElement>) {
//     const f = e.target.files?.[0];
//     if (f) {
//       setFile(f);
//       setPreview(URL.createObjectURL(f)); // preview ảnh local
//     }
//   }

//   // 🔧 Gửi formData lên API (khớp 100%)
//   async function handleCapNhat() {
//     const token = localStorage.getItem("token");
//     if (!token) {
...
//       // cập nhật user global
//       updateUser(data.nguoi_dung);

//       // set lại preview đúng URL Cloudinary
...
//   );
// }
// Updated HoSoPage with Cloudinary upload integration
"use client";
