...
export default function LienHePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF1F1] flex flex-col md:flex-row">
      {/* LOGO + THÔNG TIN */}
      <div className="md:w-1/2 flex flex-col items-center justify-start bg-[#6A0A0A] p-6 md:p-12">
        <img
          src="/logo.png"
          alt="HanFoodie Logo"
        ...
        <div className="w-full max-w-md">
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <input
              ...
              placeholder="Email"
              required
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#6A0A0A] transition"
            />
