...
export default function UserSidebar() {
  ...
  const avatar =
    user.hinh && user.hinh.trim() !== "" && user.hinh !== "null"
      ? user.hinh
      : null;
  ...
  return (
    <aside className="w-[22%] md:w-[18%] bg-white border-r shadow-sm p-5 flex flex-col items-center">
      {/* Avatar */}
      <div className="flex flex-col items-center">
        <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-[#D33C3C] bg-gray-100 shadow-md flex items-center justify-center">
          {avatar ? (
            <img src={avatar} alt="Avatar" className="w-full h-full object-cover" />
          ) : (
            <span className="text-3xl font-bold text-[#D33C3C]">
