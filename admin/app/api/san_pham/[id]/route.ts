...
//     const { het_mon, co_lai_mon } = await req.json();
...
//     if (het_mon === true) {
//       await sanpham.update({ het_mon: today });
//       return NextResponse.json({ success: true, message: "Đã đánh dấu hết món" });
//     }

//     if (co_lai_mon === true) {
//       await sanpham.update({ het_mon: null });
//       return NextResponse.json({ success: true, message: "Đã mở bán lại" });
//     }
...
//   }
// }
// ================= API SẢN PHẨM (ĐÃ GHÉP CHUẨN HẾT MÓN / CÓ LẠI MÓN) =================
...
// =====================================================
//        PATCH — HẾT MÓN / CÓ LẠI MÓN (CHUẨN MÓN THÊM)
// =====================================================
// export async function PATCH(
//   req: Request,
//   ctx: { params: Promise<{ id: string }> }
...
//     const isHetMon = !!sp.het_mon;

//     if (isHetMon) {
//       sp.het_mon = null;                     // 👉 Mở bán lại
//     } else {
//       sp.het_mon = new Date();               // 👉 Đánh dấu hết món
//     }

//     await sp.save();

//     return NextResponse.json({
//       message: isHetMon ? "Đã mở bán lại" : "Đã đánh dấu hết món",
//       het_mon: sp.het_mon,
//     });
//   } catch (error) {
...
//   const { id } = await context.params;   // ⬅️ QUAN TRỌNG: phải await
