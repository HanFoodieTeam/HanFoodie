...
// // // // // // =======================================
// // // // // // 📤 Upload Cloudinary – KHÔNG DÙNG ANY
// // // // // // =======================================
// // // // // async function uploadCloud(file: File): Promise<string> {
// // // // //   const buffer = Buffer.from(await file.arrayBuffer());
// // // // //   const base64 = `data:${file.type};base64,${buffer.toString("base64")}`;
...
// // // // // // =======================================
// // // // // // ✏️ PUT — Cập nhật sản phẩm (KHÔNG ANY)
// // // // // // =======================================
// // // // // export async function PUT(
// // // // //   req: Request,
// // // // //   { params }: { params: { id: string } }
...
// // // // //     const listHinh = form.getAll("hinh_phu");
...
// // // // //     // =============================
// // // // //     // 4️⃣ Biến thể – KHÔNG ANY
// // // // //     // =============================
// // // // //     await BienTheModel.destroy({ where: { id_san_pham: productId } });

// // // // //     const bienTheRaw = form.get("bien_the");
// // // // //     let bienTheList: Array<{
// // // // //       ten: string;
// // // // //       trang_thai: number;
// // // // //       gia_them?: number | null;
// // // // //     }> = [];
...
// // // // //       bienTheList = JSON.parse(bienTheRaw);
// // // // //     }
...
// // // // // =======================================
// // // // // ✏️ PUT — Cập nhật sản phẩm (FIX ẢNH PHỤ)
// // // // // =======================================
// // // // export async function PUT(
// // // //   req: Request,
// // // //   { params }: { params: { id: string } }
...
// // // //     // =============================
// // // //     // 3️⃣ Hình phụ (✅ CHỈ XOÁ KHI CÓ ẢNH MỚI)
// // // //     // =============================
// // // //     const listHinh = form.getAll("hinh_phu");

// // // //     if (listHinh.length > 0) {
// // // //       // ✅ Chỉ xóa khi chắc chắn có ảnh mới
// // // //       await HinhModel.destroy({ where: { id_san_pham: productId } });
...
// // // // =======================================
// // // // 🔧 Cloudinary Config — NEXT.JS CHUẨN
// // // // =======================================
// // // cloudinary.config({
// // //   cloud_name: process.env.CLOUDINARY_CLOUD,
// // //   api_key: process.env.CLOUDINARY_KEY,
...
// // //     // =============================
// // //     // 3️⃣ Hình phụ (chỉ xóa khi có hình mới)
// // //     // =============================
// // //     const rawList = form.getAll("hinh_phu");
// // //     const newImages = rawList.filter(
// // //       (i) => i instanceof File && i.size > 0
// // //     );
...
// =======================================================
// 🔧 CLOUDINARY CONFIG — DÙNG ĐÚNG BIẾN ĐANG CÓ TRONG .env
// =======================================================
cloudinary.config({
  cloud_name: process.env.CLOUDINARY_CLOUD_NAME,
  api_key: process.env.CLOUDINARY_API_KEY,
...
// =======================================================
// ✏️ PUT — Cập nhật sản phẩm + không xoá biến thể
// =======================================================
export async function PUT(
  req: Request,
  ctx: { params: Promise<{ id: string }> }
  ...
  try {
    ...
    // -----------------------------
    // 3️⃣ HÌNH PHỤ — CHỈ XỬ LÝ KHI CÓ FILE MỚI
    // -----------------------------
    const rawList = form.getAll("hinh_phu");
    const newImages = rawList.filter(
      (i): i is File => i instanceof File && i.size > 0
    );
    ...
    // -----------------------------
    // 4️⃣ BIẾN THỂ — UPDATE + THÊM MỚI, KHÔNG XOÁ
    // -----------------------------
    const bienTheRaw = form.get("bien_the");
