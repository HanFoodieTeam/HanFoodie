...
export default function ThemLoaiTuyChon() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.ten.trim()) {
      alert("Tên loại tùy chọn không được để trống");
      return;
    }
  ...
  return (
    <div className="p-4 bg-white rounded-xl shadow-md max-w-4xl mx-auto">
      ...
      >
        {/* Tên loại tùy chọn */}
        <div>
          <label className="block mb-1 font-medium">Tên loại tùy chọn</label>
          <input
            name="ten"
            value={form.ten}
        ...
        <div className="md:col-span-2 flex justify-end">
          ...
          >
            {loading ? "Đang lưu..." : "Lưu loại tùy chọn"}
          </button>
        </div>
      </form>
    </div>
